...
class AsyncTransport(ABC):
    ...
    @overload
    async def function_call(self, function_name: Literal['WinGetPID'], args: Optional[list[str]] = None) -> Union[IntegerResponseMessage, NoValueResponseMessage]: ...
    @overload
    async def function_call(self, function_name: Literal['WinGetProcessName'], args: Optional[list[str]] = None) -> Union[NoValueResponseMessage, StringResponseMessage]: ...
    @overload
    async def function_call(self, function_name: Literal['WinGetProcessPath'], args: Optional[list[str]] = None) -> Union[NoValueResponseMessage, StringResponseMessage]: ...
    @overload
